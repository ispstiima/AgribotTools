...
[![Docs](https://img.shields.io/badge/docs-GitHub%20Pages-blue)](https://ispstiima.github.io/ROSETTA/)
...
```bash
# Start the GUI (assuming you are in the rosetta repository root)
uv run gui.py
```
...
📖 **Full documentation** is available at **[ispstiima.github.io/rosetta](https://ispstiima.github.io/rosetta/)**, including:

- [Getting Started](https://ispstiima.github.io/rosetta/getting-started/) — Installation and environment setup
- [Formats](https://ispstiima.github.io/rosetta/formats/overview/) — Detailed format specifications
- [Conversions](https://ispstiima.github.io/rosetta/conversions/overview/) — Conversion matrix and usage guide
- [GUI](https://ispstiima.github.io/rosetta/gui/usage/) — Gradio interface documentation
- [API Reference](https://ispstiima.github.io/rosetta/api/formats/) — Python API documentation
- [Contributing](https://ispstiima.github.io/rosetta/contributing/) — How to extend ROSETTA
